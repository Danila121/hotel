...
from .models import Room, RoomElement, IncompatibleRoomElement, RoomElementAssignment
...
class RoomElementForm(forms.ModelForm):
    class Meta:
        model = RoomElement
        fields = ['name', 'element_type', 'room_type']
...
class RoomElementAssignmentForm(forms.ModelForm):
    class Meta:
        model = RoomElementAssignment
        fields = ['room', 'element']
